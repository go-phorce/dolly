...
var pemTests = []pemTest{
	...
	},
	{
		...
		caBundleFile: testIntCaBundle,
		rootCaFile:   testCaBundle,
		expErr:       "failed to bundle: {\"code\":1002,\"message\":\"Failed to decode certificate\"}",
	},
	{
		name:         "corruptCert",
		cert:         corruptCert,
	...
	},
	{
		...
		caBundleFile: testIntCaBundle,
		rootCaFile:   testCaBundle,
		expErr:       "failed to bundle: {\"code\":1003,\"message\":\"Failed to parse certificate\"}",
	},
	{
		name:         "selfSignedCert",
		cert:         selfSignedCert,
...
func Test_LoadAndVerifyBundleFromPEM(t *testing.T) {
	...
	assert.Equal(t, "[TEST] Dolly Level 2 CA", crt.Subject.CommonName)
}
